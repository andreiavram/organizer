...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskItem.completed_date'
        db.add_column(u'organize_taskitem', 'completed_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskItem.completed_date'
        db.delete_column(u'organize_taskitem', 'completed_date')
